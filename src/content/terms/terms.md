---
title: "伺服器規範"
description: "本伺服器的 Minecraft 伺服器及社群行為規範"
...
14. 管理員會以嚴重程度判斷封鎖時間。  
15. 使用者在本伺服器所產生之任何電磁紀錄（檔案）之所有權為本伺服器管理員，我們能自由運用這些電磁紀錄在任何地方，並且我們可以禁止任何人使用任何方法複製/盜取本伺服器的任何電磁紀錄。  
...
14. 禁止宣傳極端、恐怖主義、陰謀論等
> 為了避免爭議及保護用戶安全，禁止宣傳如陰謀論、仇恨言論、鼓吹暴力等內容。
